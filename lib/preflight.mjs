...
// ---- 8b. RETIRED 2026-09-11. --------------------------------------------
// The pass-2 coverage gate required a full watchlist sweep before any OPEN or ADD.
// It was built after run 4 deployed without research. It worked as designed and the
// strategy it protected still lost: 61 runs, ~1,200 searches, -1.94% against +7.42%
// for doing nothing. The rewrite has almost no discretionary opens to gate, so the
// gate now only adds friction to redeploying grid profit. Removed with the rest of
// the research protocol rather than left as a dead import.
